    ...
    return function a(b, c, d) {
        ...
        1: [function (a, b, c) {
            !function (a) {
                ...
                var e = "undefined" != typeof Uint8Array ? Uint8Array : Array, f = "+".charCodeAt(0),
                    g = "/".charCodeAt(0), h = "0".charCodeAt(0), i = "a".charCodeAt(0), j = "A".charCodeAt(0),
                    k = "-".charCodeAt(0), l = "_".charCodeAt(0);
        ...
        3: [function (a, b, c) {
            (function (b) {
                ...
                f.prototype.slice = function (a, b) {
                    ...
                    var d;
                    if (f.TYPED_ARRAY_SUPPORT) d = f._augment(this.subarray(a, b)); else {
                        var e = b - a;
                        d = new f(e, void 0);
                    ...
                    var e, g = d - c;
                    if (this === a && c < b && b < d) for (e = g - 1; e >= 0; e--) a[e + b] = this[e + c]; else if (g < 1e3 || !f.TYPED_ARRAY_SUPPORT) for (e = 0; e < g; e++) a[e + b] = this[e + c]; else a._set(this.subarray(c, c + g), b);
                    return g
                    ...
                    if (c !== b && 0 !== this.length) {
                        ...
                        var d;
                        if ("number" == typeof a) for (d = b; d < c; d++) this[d] = a; else {
            ...
            var e = e || function (a) {
                ...
                if (!(void 0 === a || "undefined" != typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent))) {
                    var b = a.document, c = function () {
                        ...
                        }, d = b.createElementNS("http://www.w3.org/1999/xhtml", "a"), e = "download" in d,
                        f = function (a) {
                            var b = new MouseEvent("click");
                            a.dispatchEvent(b)
                        }, g = /constructor/i.test(a.HTMLElement) || a.safari,
                        h = /CriOS\/[\d]+/.test(navigator.userAgent), i = function (b) {
                ...
                !function (b, e) {
                    ...
                    function m(a, b, c) {
                        for (; ;) {
                            var d = k(a, b);
                            if (256 === d) return ke;
                            if (d < 256) a.dest[a.destLen++] = d; else {
                                var e, f, g, h;
                    ...
                    function B(a, b, c) {
                        var d = b.length, e = new Array(d + 1);
                    ...
                    function E(a) {
                        z.call(this, "scriptListTable", C("scriptRecord", a, function (a, b) {
                            var c = a.script, d = c.defaultLangSys;
                            return xe.assert(!!d, "Unable to write GSUB: script " + a.tag + " has no default language system."), [{
                                ...
                                value: new z("scriptTable", [{
                                    ...
                                    var c = a.langSys;
                                    return [{name: "langSysTag" + b, type: "TAG", value: a.tag}, {
                                        name: "langSys" + b,
                                        type: "TABLE",
                                        value: new z("langSys", [{
                                            name: "lookupOrder",
                    ...
                    function F(a) {
                        z.call(this, "featureListTable", C("featureRecord", a, function (a, b) {
                            var c = a.feature;
                            return [{name: "featureTag" + b, type: "TAG", value: a.tag}, {
                                name: "feature" + b,
                                type: "TABLE",
                    ...
                    function R(a, b) {
                        ...
                        for (var d = 0; d < c; d += 1) for (var e = b.parseULong(), f = b.parseULong(), g = b.parseULong(), h = e; h <= f; h += 1) a.glyphIndexMap[h] = g, g++
                    }
                    ...
                    function T(a, b) {
                        ...
                        for (var d = -1, e = c.numTables - 1; e >= 0; e -= 1) {
                            var f = Le.getUShort(a, b + 4 + 8 * e), g = Le.getUShort(a, b + 4 + 8 * e + 2);
                        ...
                        if (c.format = h.parseUShort(), 12 === c.format) R(c, h); else {
                    ...
                    function W(a) {
                        ...
                        var d = [{name: "version", type: "USHORT", value: 0}, {
                            name: "numTables",
                            type: "USHORT",
                            value: c ? 1 : 2
                        ...
                        c || (d = d.concat([{
                            ...
                            type: "ULONG",
                            value: 0
                        }])), d = d.concat([{name: "format", type: "USHORT", value: 4}, {
                            name: "cmap4Length",
                            type: "USHORT",
                            value: 0
                        ...
                        V(e);
                        var h = e.segments.length, i = 0, j = [], k = [], l = [], m = [], n = [], o = [];
                        for (b = 0; b < h; b += 1) {
                            var p = e.segments[b];
                            p.end <= 65535 && p.start <= 65535 ? (j = j.concat({
                                ...
                                type: "ULONG",
                                value: p.end
                            }), o = o.concat({name: "cmap12Glyph_" + b, type: "ULONG", value: p.glyphIndex}))
                        }
                    ...
                    function ea(a, b) {
                        var c = this;
                        if (this.font = a, this.glyphs = {}, Array.isArray(b)) for (var d = 0; d < b.length; d++) c.glyphs[d] = b[d];
                    ...
                    function ka(a, b, c) {
                        var d, e, f = [], g = [], h = Le.getCard16(a, b);
                        if (0 !== h) {
                    ...
                    function ua(a, b, c, d) {
                        for (var e = [], f = 0; f < c.length; f += 1) {
                            var g = new DataView(new Uint8Array(c[f]).buffer), h = sa(g, d);
                    ...
                    function va(a, b, c, d) {
                        ...
                        c -= 1;
                        var h = [".notdef"], i = g.parseCard8();
                        if (0 === i) for (var j = 0; j < c; j += 1) e = g.parseSID(), h.push(pa(d, e)); else if (1 === i) for (; h.length <= c;) {
                    ...
                    function wa(a, b, c) {
                        var d, e = {}, f = new Le.Parser(a, b), g = f.parseCard8();
                        if (0 === g) for (var h = f.parseCard8(), i = 0; i < h; i += 1) d = f.parseCard8(), e[d] = i; else {
                            if (1 !== g) throw new Error("Unknown encoding format " + g);
                            var j = f.parseCard8();
                            d = 1;
                            for (var k = 0; k < j; k += 1) for (var l = f.parseCard8(), m = f.parseCard8(), n = l; n <= l + m; n += 1) e[n] = d, d += 1
                        }
                        return new Z(e, c)
                    }
                    ...
                    function ya(a, b, c, d) {
                        var e, f = [], g = new Le.Parser(a, b), h = g.parseCard8();
                        if (0 === h) for (var i = 0; i < c; i++) {
                    ...
                    function za(a, b, c) {
                        c.tables.cff = {};
                        var d = ra(a, b), e = ka(a, d.endOffset, Le.bytesToString), f = ka(a, e.endOffset),
                            g = ka(a, f.endOffset, Le.bytesToString), h = ka(a, g.endOffset);
                    ...
                    function Ba() {
                        return new Ie.Record("Header", [{name: "major", type: "Card8", value: 1}, {
                            name: "minor",
                            type: "Card8",
                            value: 0
                    ...
                    function Fa(a) {
                        var b = new Ie.Record("Top DICT INDEX", [{name: "topDicts", type: "INDEX", value: []}]);
                        return b.topDicts = [{name: "topDict_0", type: "TABLE", value: a}], b
                    }

                    function Ga(a) {
                        var b = new Ie.Record("String INDEX", [{name: "strings", type: "INDEX", value: []}]);
                        b.strings = [];
                    ...
                    function Ma(a, b) {
                        for (var c, d = new Ie.Table("CFF ", [{name: "header", type: "RECORD"}, {
                            name: "nameIndex",
                            type: "RECORD"
                    ...
                    function Oa(a) {
                        var b = Math.round((new Date).getTime() / 1e3) + 2082844800, c = b;
                    ...
                    function Qa(a) {
                        return new Ie.Table("hhea", [{name: "version", type: "FIXED", value: 65536}, {
                            name: "ascender",
                            type: "FWORD",
                            value: 0
                    ...
                    function Ta(a) {
                        for (var b = new Ie.Table("ltag", [{name: "version", type: "ULONG", value: 1}, {
                            name: "flags",
                            type: "ULONG",
                            value: 0
                        }, {
                    ...
                    function Ua(a, b) {
                        var c = new Le.Parser(a, b), d = c.parseULong();
                    ...
                    function Wa(a) {
                        return new Ie.Table("maxp", [{name: "version", type: "FIXED", value: 20480}, {
                            name: "numGlyphs",
                            type: "USHORT",
                            value: a
                        }])
                    ...
                    function Za(a, b, c) {
                        for (var d = {}, e = new Le.Parser(a, b), f = e.parseUShort(), g = e.parseUShort(), h = e.offset + e.parseUShort(), i = 0; i < g; i++) {
                            var j = e.parseUShort(), k = e.parseUShort(), l = e.parseUShort(), m = e.parseUShort(),
                                n = _e[m] || m, o = e.parseUShort(), p = e.parseUShort(), q = Xa(j, l, c),
                                r = Ya(j, k, l);
                    ...
                    function cb(a, b) {
                        ...
                        for (var z = new Ie.Table("name", [{name: "format", type: "USHORT", value: 0}, {
                            name: "count",
                            type: "USHORT",
                            value: k.length
                        }, {
                    ...
                    function fb(a) {
                        return new Ie.Table("OS/2", [{
                            ...
                            type: "USHORT",
                            value: 0
                        }, {name: "usMaxContext", type: "USHORT", value: 0}], a)
                    }
                    ...
                    function gb(a, b) {
                        ...
                        switch (c.version = d.parseVersion(), c.italicAngle = d.parseFixed(), c.underlinePosition = d.parseShort(), c.underlineThickness = d.parseShort(), c.isFixedPitch = d.parseULong(), c.minMemType42 = d.parseULong(), c.maxMemType42 = d.parseULong(), c.minMemType1 = d.parseULong(), c.maxMemType1 = d.parseULong(), c.version) {
                            ...
                            case 2:
                                ...
                                c.names = [];
                                for (var f = 0; f < c.numberOfGlyphs; f++) if (c.glyphNameIndex[f] >= Qe.length) {
                                    var g = d.parseChar();
                    ...
                    function ib(a, b) {
                        b = b || 0;
                        var c = new Q(a, b), d = c.parseVersion(1);
                    ...
                    function jb(a) {
                        return new Ie.Table("GSUB", [{name: "version", type: "ULONG", value: 65536}, {
                            name: "scripts",
                            type: "TABLE",
                    ...
                    function kb(a, b) {
                        ...
                        for (var e = c.parseULong(), f = {}, g = 0; g < e; g++) {
                            var h = c.parseTag(), i = c.parseULong(), j = c.parseULong(), k = Ae.UTF8(a, b + i, j);
                            f[h] = k
                        }
                        return f
                    }
                    ...
                    function lb(a) {
                        var b = Object.keys(a).length, c = "", d = 16 + 12 * b,
                            e = new Ie.Table("meta", [{name: "version", type: "ULONG", value: 1}, {
                                name: "flags",
                                type: "ULONG",
                                value: 0
                            }, {name: "offset", type: "ULONG", value: d}, {name: "numTags", type: "ULONG", value: b}]);
                        for (var f in a) {
                            var g = c.length;
                            c += a[f], e.fields.push({
                                name: "tag " + f,
                    ...
                    function pb(a) {
                        var b = new Ie.Table("sfnt", [{name: "version", type: "TAG", value: "OTTO"}, {
                            name: "numTables",
                            type: "USHORT",
                            value: 0
                        }, {name: "searchRange", type: "USHORT", value: 0}, {
                        ...
                        for (var g = 0; g < a.length; g += 1) {
                            ...
                            var i = h.sizeOf(), j = ob(h.tableName, nb(h.encode()), f, i);
                            for (d.push({
                    ...
                    function sb(a) {
                        for (var b, c = [], d = [], e = [], f = [], g = [], h = [], i = [], j = 0, k = 0, l = 0, m = 0, n = 0, o = 0; o < a.glyphs.length; o += 1) {
                            ...
                            if (r < 32) k |= 1 << r; else if (r < 64) l |= 1 << r - 32; else if (r < 96) m |= 1 << r - 64; else {
                        ...
                        var u = We.make({
                            ...
                            }), w = $e.make(a.glyphs.length), x = jf.make({
                            ...
                            }), y = Ye.make(a.glyphs), z = Me.make(a.glyphs), A = a.getEnglishName("fontFamily"),
                            B = a.getEnglishName("fontSubfamily"), C = A + " " + B,
                        ...
                        var G = [], H = gf.make(E, G), I = G.length > 0 ? Ze.make(G) : void 0, J = kf.make(),
                            K = Ve.make(a.glyphs, {
                        ...
                        for (var N = pb(M), O = N.encode(), P = nb(O), Q = N.fields, R = !1, S = 0; S < Q.length; S += 1) if ("head table" === Q[S].name) {
                    ...
                    function Gb(a, b, c) {
                        ...
                        if (a.numberOfContours > 0) {
                            ...
                            e = [];
                            for (var k = 0; k < j; k += 1) if (f = d.parseByte(), e.push(f), (8 & f) > 0) for (var l = d.parseByte(), m = 0; m < l; m += 1) e.push(f), k += 1;
                    ...
                    function Jb(a) {
                        ...
                        for (var c = Ib(a), d = 0; d < c.length; ++d) {
                            ...
                            if (g.onCurve) b.moveTo(g.x, g.y); else if (h.onCurve) b.moveTo(h.x, h.y); else {
                                var i = {x: .5 * (g.x + h.x), y: .5 * (g.y + h.y)};
                                b.moveTo(i.x, i.y)
                            }
                            for (var j = 0; j < e.length; ++j) if (f = g, g = h, h = e[(j + 1) % e.length], g.onCurve) b.lineTo(g.x, g.y); else {
                                var k = h;
                                f.onCurve || {
                                    x: .5 * (g.x + f.x),
                                    y: .5 * (g.y + f.y)
                    ...
                    function Kb(a, b) {
                        if (b.isComposite) for (var c = 0; c < b.components.length; c += 1) {
                            ...
                            if (e.getPath(), e.points) {
                                var f = void 0;
                                if (void 0 === d.matchedPoints) f = Hb(e.points, d); else {
                                    ...
                                    var g = b.points[d.matchedPoints[0]], h = e.points[d.matchedPoints[1]], i = {
                                        xScale: d.xScale,
                                        scale01: d.scale01,
                                        scale10: d.scale10,
                                        yScale: d.yScale,
                    ...
                    function ac(b, c) {
                        var d = c.stack, e = d.pop(), f = d.pop(), g = c.z2[e], h = c.z1[f];
                    ...
                    function hc(b) {
                        var c = b.stack, d = c.pop(), e = c.pop(), f = c.pop(), g = c.pop(), h = c.pop(), i = b.z0,
                            j = b.z1, k = i[d], l = i[e], m = j[f], n = j[g], o = b.z2[h];
                        a.DEBUG && console.log("ISECT[], ", d, e, f, g, h);
                        var p = k.x, q = k.y, r = l.x, s = l.y, t = m.x, u = m.y, v = n.x, w = n.y,
                            x = (p - r) * (u - w) - (q - s) * (t - v), y = p * s - q * r, z = t * w - u * v;
                    ...
                    function Fc(b) {
                        ...
                        var c = b.stack, d = b.prog, e = b.ip, f = c.pop(), g = e;
                        for (a.DEBUG && console.log(b.step, "FDEF[]", f); 45 !== d[++e];) ;
                        b.ip = e, b.funcs[f] = d.slice(g + 1, e)
                    }

                    function Gc(b, c) {
                        var d = c.stack.pop(), e = c.z0[d], f = c.fv, g = c.pv;
                    ...
                    function Jc(b, c) {
                        var d = c.stack, e = b ? c.rp1 : c.rp2, f = (b ? c.z0 : c.z1)[e], g = c.fv, h = c.pv,
                            i = d.pop(), j = c.z2[c.contours[i]], k = j;
                    ...
                    function Nc(b, c) {
                        var d = c.stack, e = d.pop() / 64, f = d.pop(), g = c.z1[f], h = c.z0[c.rp0], i = c.fv,
                            j = c.pv;
                    ...
                    function Qc(b, c) {
                        var d = c.stack, e = d.pop(), f = d.pop(), g = c.z0[f], h = c.fv, i = c.pv, j = c.cvt[e];
                    ...
                    function Rc(b) {
                        var c = b.prog, d = b.ip, e = b.stack, f = c[++d];
                    ...
                    function Sc(b) {
                        var c = b.ip, d = b.prog, e = b.stack, f = d[++c];
                    ...
                    function Uc(b) {
                        var c = b.stack, d = b.store, e = c.pop();
                    ...
                    function Xc(b, c) {
                        var d = c.stack, e = d.pop(), f = c.z2[e];
                        a.DEBUG && console.log(c.step, "GC[" + b + "]", e), d.push(64 * c.dpv.distance(f, zf, b, !1))
                    }

                    function Yc(b, c) {
                        var d = c.stack, e = d.pop(), f = d.pop(), g = c.z1[e], h = c.z0[f],
                    ...
                    function md(b, c) {
                        var d = c.stack, e = d.pop(), f = c.fv, g = c.pv, h = c.ppem, i = c.deltaBase + 16 * (b - 1),
                            j = c.deltaShift, k = c.z0;
                    ...
                    function zd(b, c) {
                        var d = c.stack, e = d.pop(), f = c.ppem, g = c.deltaBase + 16 * (b - 1), h = c.deltaShift;
                    ...
                    function Md(b) {
                        var c = b.stack.pop(), d = b.stack.pop();
                    ...
                    function Pd(b, c, d, e, f, g) {
                        var h, i, j, k, l = g.stack, m = b && l.pop(), n = l.pop(), o = g.rp0, p = g.z0[o], q = g.z1[n],
                            r = g.minDis, s = g.fv, t = g.dpv;
                    ...
                    function Sd(a, b, c) {
                        var d = Rd(b.name, c);
                        return [{name: "tag_" + a, type: "TAG", value: b.tag}, {
                            name: "minValue_" + a,
                            type: "FIXED",
                            value: b.minValue << 16
                        }, {
                    ...
                    function Ud(a, b, c, d) {
                        for (var e = Rd(b.name, d), f = [{
                            ...
                            type: "USHORT",
                            value: e
                        }, {name: "flags_" + a, type: "USHORT", value: 0}], g = 0; g < c.length; ++g) {
                            var h = c[g].tag;
                    ...
                    function Xd(a, b, c) {
                        var d = new Le.Parser(a, b), e = d.parseULong();
                    ...
                    function Zd(a) {
                        return new Ie.Table("GPOS", [{name: "version", type: "ULONG", value: 65536}, {
                            name: "scripts",
                            type: "TABLE",
                            value: new Ie.ScriptList(a.scripts)
                        }, {name: "features", type: "TABLE", value: new Ie.FeatureList(a.features)}, {
                    ...
                    function ae(a, b) {
                        var c = new Le.Parser(a, b), d = c.parseUShort();
                        if (0 === d) return $d(c);
                        if (1 === d) return _d(c);
                    ...
                    function ee(a, b) {
                        for (var c = [], d = 12, e = 0; e < b; e += 1) {
                            var f = Le.getTag(a, d), g = Le.getULong(a, d + 4), h = Le.getULong(a, d + 8),
                    ...
                    function he(a) {
                        var b, c, d, e = new Qd({empty: !0}), f = new DataView(a, 0), g = [], h = Le.getTag(f, 0);
                        if (h === String.fromCharCode(0, 1, 0, 0) || "true" === h || "typ1" === h) e.outlinesFormat = "truetype", d = Le.getUShort(f, 4), g = ee(f, d); else if ("OTTO" === h) e.outlinesFormat = "cff", d = Le.getUShort(f, 4), g = ee(f, d); else {
                            if ("wOFF" !== h) throw new Error("Unsupported OpenType signature " + h);
                            var i = Le.getTag(f, 4);
                            if (i === String.fromCharCode(0, 1, 0, 0)) e.outlinesFormat = "truetype"; else {
                        ...
                        if (e.tables.name = gf.parse(x.data, x.offset, c), e.names = e.tables.name, l && q) {
                            var y = 0 === b, z = ge(f, q), A = Hf.parse(z.data, z.offset, e.numGlyphs, y), B = ge(f, l);
                    ...
                    var ke = 0, le = -3, me = new c, ne = new c, oe = new Uint8Array(30), pe = new Uint16Array(30),
                        qe = new Uint8Array(30), re = new Uint16Array(30),
                        se = new Uint8Array([16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15]),
                        te = new c, ue = new Uint8Array(320), ve = new Uint16Array(16);
                    ...
                    q.prototype.isEmpty = function () {
                        ...
                        var i = this, j = [a, b], k = [c, d], l = [e, f], m = [g, h];
                        this.addPoint(a, b), this.addPoint(g, h);
                        for (var n = 0; n <= 1; n++) {
                            var o = 6 * j[n] - 12 * k[n] + 6 * l[n], q = -3 * j[n] + 9 * k[n] - 9 * l[n] + 3 * m[n],
                                r = 3 * k[n] - 3 * j[n];
                            if (0 !== q) {
                        ...
                        var g = a + 2 / 3 * (c - a), h = b + 2 / 3 * (d - b), i = g + 1 / 3 * (e - a),
                            j = h + 1 / 3 * (f - b);
                        ...
                        var b = this.toPathData(a), c = document.createElementNS("http://www.w3.org/2000/svg", "path");
                        return c.setAttribute("d", b), c
                    };
                    var xe = {fail: s, argument: t, assert: t}, ye = 32768, ze = 2147483648, Ae = {}, Be = {}, Ce = {};
                    Be.BYTE = function (a) {
                    ...
                    var Ee, Fe = "function" == typeof WeakMap && new WeakMap, Ge = function (a) {
                        if (!Ee) {
                            Ee = {};
                    ...
                    Be.MACSTRING = function (a, b) {
                        ...
                        var c = [];
                        if (Array.isArray(b)) for (var d = 0; d < b.length; d += 1) xe.argument(a.length === b.length, "Not enough arguments given for type" + b), c = c.concat(Be.OPERAND(a[d], b[d])); else if ("SID" === b) c = c.concat(Be.NUMBER(a)); else if ("offset" === b) c = c.concat(Be.NUMBER32(a)); else if ("number" === b) c = c.concat(Be.NUMBER(a)); else {
                    ...
                    Q.prototype.parseByte = function () {
                        ...
                        var a = this.offset + this.relativeOffset, b = this.parseUShort();
                        if (1 === b) return {
                            format: 1,
                        ...
                        if (2 === b) return {
                            format: 2,
                            ranges: this.parseRecordList({start: Q.uShort, end: Q.uShort, classId: Q.uShort})
                        };
                    ...
                    Q.prototype.parseScriptList = function () {
                        ...
                        return this.parsePointer(Q.recordList({
                            tag: Q.tag,
                            feature: Q.pointer({featureParams: Q.offset16, lookupListIndexes: Q.uShortList})
                        })) || []
                        ...
                        return this.parsePointer32(function () {
                            var a = this.parseUShort(), b = this.parseUShort();
                    ...
                    X.prototype.charToGlyphIndex = function (a) {
                        var b = a.codePointAt(0), c = this.font.glyphs;
                        if (c) for (var d = 0; d < c.length; d += 1) for (var e = c.get(d), f = 0; f < e.unicodes.length; f += 1) if (e.unicodes[f] === b) return d;
                        return null
                        ...
                        var b = a.codePointAt(0), c = this.encoding[b];
                    ...
                    ca.prototype.bindConstructorValues = function (a) {
                        ...
                        var f, g;
                        d || (d = {});
                        var h = d.xScale, i = d.yScale;
                        if (d.hinting && e && e.hinting && (g = this.path && e.hinting.exec(this, c)), g) f = e.hinting.getCommands(g), a = Math.round(a), b = Math.round(b), h = i = 1; else {
                        ...
                        var f = this.xMin || 0, g = this.yMin || 0, h = this.xMax || 0, i = this.yMax || 0,
                    ...
                    var Se = {GlyphSet: ea, glyphLoader: fa, ttfGlyphLoader: ga, cffGlyphLoader: ha},
                        ...
                        Ue = [{name: "subrs", op: 19, type: "offset", value: 0}, {
                            name: "defaultWidthX",
                            op: 20,
                            type: "number",
                            value: 0
                        }, {name: "nominalWidthX", op: 21, type: "number", value: 0}], Ve = {parse: za, make: Ma},
                        We = {parse: Na, make: Oa}, Xe = {parse: Pa, make: Qa}, Ye = {parse: Ra, make: Sa},
                        Ze = {make: Ta, parse: Ua}, $e = {parse: Va, make: Wa},
                        ...
                        hf = [{begin: 0, end: 127}, {begin: 128, end: 255}, {begin: 256, end: 383}, {
                            begin: 384,
                            end: 591
                        ...
                        }, {begin: 6144, end: 6319}, {begin: 10240, end: 10495}, {
                            begin: 40960,
                            end: 42127
                        }, {begin: 5888, end: 5919}, {begin: 66304, end: 66351}, {
                            begin: 66352,
                            end: 66383
                        }, {begin: 66560, end: 66639}, {begin: 118784, end: 119039}, {
                            begin: 119808,
                            end: 120831
                        ...
                        }, {begin: 11264, end: 11359}, {begin: 11568, end: 11647}, {
                            begin: 19904,
                            end: 19967
                        }, {begin: 43008, end: 43055}, {begin: 65536, end: 65663}, {
                            begin: 65856,
                            end: 65935
                        }, {begin: 66432, end: 66463}, {begin: 66464, end: 66527}, {
                            begin: 66640,
                            end: 66687
                        }, {begin: 66688, end: 66735}, {begin: 67584, end: 67647}, {
                            begin: 68096,
                            end: 68191
                        }, {begin: 119552, end: 119647}, {begin: 73728, end: 74751}, {
                            begin: 119648,
                            end: 119679
                        }, {begin: 7040, end: 7103}, {begin: 7168, end: 7247}, {begin: 7248, end: 7295}, {
                            begin: 43136,
                            end: 43231
                        }, {begin: 43264, end: 43311}, {begin: 43312, end: 43359}, {
                            begin: 43520,
                            end: 43615
                        }, {begin: 65936, end: 65999}, {begin: 66e3, end: 66047}, {
                            begin: 66208,
                            end: 66271
                        }, {begin: 127024, end: 127135}],
                        jf = {parse: eb, make: fb, unicodeRanges: hf, getUnicodeRange: db}, kf = {parse: gb, make: hb},
                        lf = new Array(9);
                    lf[1] = function () {
                        var a = this.offset + this.relativeOffset, b = this.parseUShort();
                        return 1 === b ? {
                    ...
                    lf[5] = function () {
                        ...
                        if (1 === b) return {
                            ...
                            ruleSets: this.parseListOfLists(function () {
                                var a = this.parseUShort(), b = this.parseUShort();
                                return {input: this.parseUShortList(a - 1), lookupRecords: this.parseRecordList(b, mf)}
                            })
                        };
                        if (2 === b) return {
                            substFormat: b,
                        ...
                        var b = this.parseUShort(), c = new Q(this.data, this.offset + this.parseULong());
                    ...
                    var of = {parse: ib, make: jb}, pf = {parse: kb, make: lb},
                        qf = {make: pb, fontToTable: sb, computeCheckSum: nb};
                    wb.prototype = {
                        searchTag: tb, binSearch: ub, getTable: function (a) {
                            ...
                            if (c) {
                                a = a || "DFLT";
                                var d = c.scripts, e = tb(c.scripts, a);
                            ...
                            if (e) {
                                for (var f, g = e.featureIndexes, h = this.font.tables[this.tableName].features, i = 0; i < g.length; i++) if (f = h[g[i]], f.tag === c) return f.feature;
                                if (d) {
                                    var j = h.length;
                            ...
                            var f = this.getFeatureTable(a, b, c, e), g = [];
                            if (f) {
                            ...
                            if (1 === a.format) return a.glyphs
                                ;
                            for (var b = [], c = a.ranges, d = 0; d < c.length; d++) for (var e = c[d], f = e.start, g = e.end, h = f; h <= g; h++) b.push(h);
                            return b
                        }
                        ...
                        for (var d = this, e = 0; e < a.length; e++) for (var f = a[e].subtables, g = 0; g < f.length; g++) {
                            var h = f[g], i = d.getCoverageIndex(h.coverage, b);
                            if (!(i < 0)) switch (h.posFormat) {
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    var m = d.getGlyphClass(h.classDef1, b), n = d.getGlyphClass(h.classDef2, c),
                        ...
                        for (var d = this, e = [], f = this.getLookupTables(b, c, a, 1), g = 0; g < f.length; g++) for (var h = f[g].subtables, i = 0; i < h.length; i++) {
                        ...
                        for (var d = this, e = [], f = this.getLookupTables(b, c, a, 3), g = 0; g < f.length; g++) for (var h = f[g].subtables, i = 0; i < h.length; i++) for (var j = h[i], k = d.expandCoverage(j.coverage), l = j.alternateSets, m = 0; m < k.length; m++) e.push({
                            sub: k[m],
                            by: l[m]
                        });
                        return e
                    }, yb.prototype.getLigatures = function (a, b, c) {
                        for (var d = this, e = [], f = this.getLookupTables(b, c, a, 4), g = 0; g < f.length; g++) for (var h = f[g].subtables, i = 0; i < h.length; i++) for (var j = h[i], k = d.expandCoverage(j.coverage), l = j.ligatureSets, m = 0; m < k.length; m++) for (var n = k[m], o = l[m], p = 0; p < o.length; p++) {
                            var q = o[p];
                        ...
                        var g = b.sub, h = this.binSearch(f.coverage.glyphs, g);
                        ...
                        var e = this.getLookupTables(c, d, a, 4, !0)[0], f = e.subtables[0];
                        f || (f = {
                            substFormat: 1,
                            coverage: {format: 1, glyphs: []},
                            ligatureSets: []
                        }, e.subtables[0] = f), xe.assert(1 === f.coverage.format, "Ligature: unable to modify coverage table format " + f.coverage.format);
                        var g = b.sub[0], h = b.sub.slice(1), i = {ligGlyph: b.by, components: h},
                            j = this.binSearch(f.coverage.glyphs, g);
                        if (j >= 0) {
                            for (var k = f.ligatureSets[j], l = 0; l < k.length; l++) if (zb(k[l].components, h)) return;
                            k.push(i)
                    ...
                    var rf, sf, tf, uf, vf = {getPath: Jb, parse: Lb}, wf = function (a) {
                        var b = this.srPeriod, c = this.srPhase, d = this.srThreshold, e = 1;
                        ...
                        x: 1, y: 0, axis: "x", distance: function (a, b, c, d) {
                            ...
                            var f = e ? b.xo : b.x, g = e ? b.yo : b.y, h = f + c * d.x, i = g + c * d.y;
                        ...
                        x: 0, y: 1, axis: "y", distance: function (a, b, c, d) {
                    ...
                    Object.freeze(xf), Object.freeze(yf), Tb.prototype.distance = function (a, b, c, d) {
                        ...
                        d = d || this;
                        var f = e ? b.xo : b.x, g = e ? b.yo : b.y, h = f + c * d.x, i = g + c * d.y, j = d.normalSlope,
                            k = this.slope, l = a.x, m = a.y;
                    ...
                    Mb.prototype.exec = function (b, c) {
                        ...
                        if (!(this._errorState > 2)) {
                            ...
                            if (!e || e.ppem !== c) {
                                ...
                                var g = d.tables.cvt;
                                if (g) for (var h = e.cvt = new Array(g.length), i = c / d.unitsPerEm, j = 0; j < g.length; j++) h[j] = g[j] * i; else e.cvt = [];
                    ...
                    Qd.prototype.hasChar = function (a) {
                        ...
                        var h = e.length;
                        if (b.features) {
                            var i = b.script || this.substitution.getDefaultScriptName(), j = [];
                            ...
                            for (var k = 0; k < h; k += 1) for (var l = 0; l < j.length; l++) {
                        ...
                        var h, i = 1 / this.unitsPerEm * d, j = this.stringToGlyphs(a, e);
                        if (e.kerning) {
                        ...
                        var c = this.getEnglishName("fontFamily"), d = this.getEnglishName("fontSubfamily");
                        ...
                        if (Bb()) window.requestFileSystem = window.requestFileSystem || window.webkitRequestFileSystem, window.requestFileSystem(window.TEMPORARY, e.byteLength, function (b) {
                            b.root.getFile(a, {create: !0}, function (a) {
                                a.createWriter(function (b) {
                                    var c = new DataView(e), d = new Blob([c], {type: "font/opentype"});
                    ...
                    var Cf = {make: Wd, parse: Xd}, Df = new Array(10);
                    Df[1] = function () {
                        var a = this.offset + this.relativeOffset, b = this.parseUShort();
                        return 1 === b ? {
                            posFormat: 1,
                        ...
                        var c = this.parsePointer(Q.coverage), d = this.parseUShort(), e = this.parseUShort();
                        if (1 === b) return {
                            posFormat: b,
                            coverage: c,
                            valueFormat1: d,
                        ...
                        if (2 === b) {
                            var f = this.parsePointer(Q.classDef), g = this.parsePointer(Q.classDef),
                                h = this.parseUShort(), i = this.parseUShort();
                            return {
                                posFormat: b,
                                coverage: c,
                                valueFormat1: d,
                    ...
                    var Ef = new Array(10), Ff = {parse: Yd, make: Zd}, Gf = {parse: ae}, Hf = {parse: be};
        ...
        14: [function (a, b, c) {
            "use strict";
            var d = a("../core/main"), e = a("../core/constants");
        ...
        15: [function (a, b, c) {
            "use strict";
            var d = a("../core/main"), e = a("../core/constants"), f = a("./color_conversion");
            ...
            d.Color._parseInputs = function (a, b, c, h) {
                var i, j = arguments.length, k = this.mode, m = this.maxes[k], n = [];
                if (j >= 3) {
        ...
        18: [function (a, b, c) {
            ...
            var h = a("./main"), i = a("./constants"), j = [i.ARROW, i.CROSS, i.HAND, i.MOVE, i.TEXT, i.WAIT];
            ...
            var d = a("./constants"), e = function (a, b, c) {
                ...
                window.DeviceOrientationEvent && (this._events.deviceorientation = null), window.DeviceMotionEvent && !window._isNodeWebkit && (this._events.devicemotion = null), this._start = function () {
                    ...
                    if (this._isGlobal) {
                        ...
                        for (var i in this) if (this.hasOwnProperty(i)) try {
                            delete window[i]
                        } catch (a) {
                            window[i] = void 0
                        }
                ...
                if (a) a(this); else {
                    ...
                    for (var i in e.prototype) if ("function" == typeof e.prototype[i]) {
                        var j = i.substring(2);
        ...
        26: [function (a, b, c) {
            ...
            var e = a("./main"), f = a("../core/constants");
        ...
        27: [function (a, b, c) {
            "use strict";
            var d = a("./main"), e = a("./constants"), f = a("../image/filters");
            a("./p5.Renderer");
            var g = "rgba(0,0,0,0)";
            d.Renderer2D = function (a, b, c) {
                ...
                var f = this._pInst || this, g = f._pixelDensity;
                a = Math.floor(a), b = Math.floor(b), c = Math.floor(c), e = Math.floor(e);
                var h = a * g, i = b * g;
                if (1 !== c || 1 !== e || this instanceof d.RendererGL) {
                    var j = Math.min(c, f.width), k = Math.min(e, f.height), l = j * g, m = k * g,
                        n = new d.Image(j, k);
                ...
                if (a._pixelsDirty) {
                    a._pixelsDirty = !1;
                    var b = a._pixelDensity, c = this.width * b, d = this.height * b,
                ...
                if (c instanceof d.Image) this.drawingContext.save(), this.drawingContext.setTransform(1, 0, 0, 1, 0, 0), this.drawingContext.scale(e._pixelDensity, e._pixelDensity), this.drawingContext.drawImage(c.canvas, a, b), this.drawingContext.restore(), e._pixelsDirty = !0; else {
                    var f = 0, g = 0, h = 0, i = 0,
                        j = 4 * (b * e._pixelDensity * (this.width * e._pixelDensity) + a * e._pixelDensity);
                    if (e.imageData && !e._pixelsDirty || e.loadPixels.call(e), "number" == typeof c) j < e.pixels.length && (f = c, g = c, h = c, i = 255); else if (c instanceof Array) {
                ...
                var e = this._pInst || this, f = e._pixelDensity;
                ...
                var i = this.drawingContext, j = c / 2, k = d / 2, l = 1e-5, m = 0, n = [];
                ...
                var b = this.drawingContext, c = this._doFill, d = this._doStroke, e = a[0], f = a[1], h = a[2],
                    i = a[3];
                if (c && !d) {
                    if (this._getFill() === g) return this
                } else if (!c && d && this._getStroke() === g) return this;
                var j = .5522847498, k = h / 2 * j, l = i / 2 * j, m = e + h, n = f + i, o = e + h / 2, p = f + i / 2;
                ...
                var d = this._getStroke(), f = this._getFill();
                ...
                var b = a[0], c = a[1], d = a[2], e = a[3], f = a[4], h = a[5], i = a[6], j = a[7],
                ...
                return c === e._CTX_MIDDLE && (c = e.CENTER), {horizontal: this.drawingContext.textAlign, vertical: c}
        ...
        29: [function (a, b, c) {
            "use strict";
            var d = a("../main"), e = a("../constants"), f = a("../helpers");
        ...
        32: [function (a, b, c) {
            "use strict";
            var d = a("../main"), e = a("../constants"), f = null, g = [], h = [], i = !1, j = !1, k = !1, l = !1,
                m = !0;
        ...
        33: [function (a, b, c) {
            ...
            window.requestAnimationFrame = function () {
                ...
                if (!Object.assign) {
                    var a = Object.keys, b = Object.defineProperty, c = function (a) {
                            return void 0 !== a && null !== a
                        }, d = "function" == typeof Symbol && "symbol" == typeof Symbol(),
                        e = Object.prototype.propertyIsEnumerable, f = function (a) {
                            return function (b) {
                                return e.call(a, b)
                            }
                        }, g = function (b, e) {
                            ...
                            for (g = 1; g < arguments.length; ++g) for (h = Object(arguments[g]), j = a(h), d && Object.getOwnPropertySymbols && j.push.apply(j, Object.getOwnPropertySymbols(h).filter(f(h))), i = 0; i < j.length; ++i) k[j[i]] = h[j[i]];
                            return k
                        };
        ...
        34: [function (a, b, c) {
            ...
            d.prototype.noLoop = function () {
                ...
                var b = parseInt(a);
                (isNaN(b) || b < 1) && (b = 1);
                var c = this.setup || window.setup, d = this.draw || window.draw;
        ...
        39: [function (a, b, c) {
            ...
            var e = a("../core/main"), f = a("../core/constants");
        ...
        43: [function (a, b, c) {
            ...
            var e = a("../core/main"), f = a("./filters"), g = a("../core/helpers"), h = a("../core/constants");
            a("../core/error_helpers"), e.prototype.loadImage = function (a, b, c) {
                e._validateParameters("loadImage", arguments);
                var d = new Image, f = new e.Image(1, 1, this), g = this;
                ...
                var o = b, p = c, q = f || m, r = h || n, s = i || 0, t = j || 0, u = k || m, v = l || n;
                u = d(u, m), v = d(v, n);
                var w = 1;
        ...
        46: [function (a, b, c) {
            ...
            function e(a) {
                var b = new i.XML, c = a.childNodes;
                if (c && c.length) {
            ...
            a("../core/error_helpers"), i.prototype.loadJSON = function () {
                ...
                "tsv" === g && (h = "\t");
                for (var k = 1; k < arguments.length; k++) if ("function" == typeof arguments[k]) void 0 === b ? b = arguments[k] : void 0 === c && (c = arguments[k]); else if ("string" == typeof arguments[k]) if (e.push(arguments[k]), "header" === arguments[k] && (f = !0), "csv" === arguments[k]) {
                ...
                return this.httpDo(a, "GET", "text", function (a) {
                    for (var c, e = {}, g = 0, j = 1, n = 2, o = 4, p = '"', q = "\r", r = "\n", s = [], t = 0, u = null, v = function () {
                        ...
                        if (e.currentState === j && e.escaped) if (c === p) a[t] === p ? (e.token += p, t++) : (e.escaped = !1, e.currentState = n); else {
                            if (c === q) continue;
                            e.token += c
                        } else c === q ? (a[t] === r && t++, w(), y()) : c === r ? (w(), y()) : c === h ? w() : e.currentState === j && (e.token += c)
                    }
                    if (f) l.columns = s.shift(); else for (k = 0; k < s[0].length; k++) l.columns[k] = "null";
                    var z;
                ...
                if (2 === k && "string" == typeof l && "object" == typeof arguments[1]) d = new Request(l, arguments[1]), b = arguments[2], c = arguments[3]; else {
                    for (var m, n = "GET", o = 1; o < arguments.length; o++) {
                        var p = arguments[o];
                        if ("string" == typeof p) "GET" === p || "POST" === p || "PUT" === p || "DELETE" === p ? n = p : "json" === p || "jsonp" === p || "binary" === p || "arrayBuffer" === p || "xml" === p || "text" === p ? a = p : m = p; else if ("number" == typeof p) m = p.toString(); else if ("object" == typeof p) if (p.hasOwnProperty("jsonpCallback")) for (var q in p) f[q] = p[q]; else m = JSON.stringify(p), h = "application/json"; else "function" == typeof p && (b ? c = p : b = p)
                    }
                ...
                }), r.catch(c || console.error), r
            }, window.URL = window.URL || window.webkitURL, i.prototype._pWriters = [], i.prototype.createWriter = function (a, b) {
                var c;
                for (var d in i.prototype._pWriters) if (i.prototype._pWriters[d].name === a) return c = new i.PrintWriter(a + this.millis(), b), i.prototype._pWriters.push(c), c;
                ...
                if (1 === d.length && "string" == typeof d[0]) i.prototype.saveCanvas(e, d[0]); else {
                    switch (g(d[1], d[2])[1]) {
                        case"json":
                ...
                var e = this.createWriter(b, d), g = a.columns, h = ",";
                if ("tsv" === d && (h = "\t"), "html" !== d) {
                    if ("0" !== g[0]) {
        ...
        52: [function (a, b, c) {
            "use strict";
            var d, e = a("../core/main"), f = 4, g = 1 << f, h = 8, i = 1 << h, j = 4095, k = 4, l = .5,
                m = function (a) {
        ...
        53: [function (a, b, c) {
            ...
            d.Vector = function () {
                ...
                var b = this.dot(a) / (this.mag() * a.mag()), c = Math.acos(Math.min(1, Math.max(-1, b)));
                ...
                void 0 === c && (c = 1);
                var e = Math.cos(b), f = Math.sin(b), g = Math.cos(a), h = Math.sin(a);
                ...
                var a = Math.random() * e.TWO_PI, b = 2 * Math.random() - 1, c = Math.sqrt(1 - b * b),
                    f = c * Math.cos(a), g = c * Math.sin(a);
        ...
        54: [function (a, b, c) {
            "use strict";
            var d = a("../core/main"), e = !1, f = !1, g = 0, h = function () {
                var a, b, c = 4294967296, d = 1664525, e = 1013904223;
                return {
                    setSeed: function (d) {
                        b = a = (null == d ? Math.random() * c : d) >>> 0
        ...
        58: [function (a, b, c) {
            ...
            function p(a, b) {
                var c, d = o(a), e = b && o(b), f = {
                    ...
                    }, g = {x: 0, y: 0, bx: 0, by: 0, X: 0, Y: 0, qx: null, qy: null}, h = [], i = [],
                    j = function (a, b, c) {
                        var d, e, f = {T: 1, Q: 1};
            ...
            var y = a("../core/main"), z = a("../core/constants");
            y.Font = function (a) {
                ...
                var f = e && e.renderer && e.renderer._pInst || this.parent, g = f._renderer.drawingContext,
                    h = g.textAlign || z.LEFT, i = g.textBaseline || z.BASELINE, j = x("textBounds", a, b, c, d, h, i),
                    k = this.cache[j];
                if (!k) {
                ...
                var i = 0, j = [], k = this._getGlyphs(a);
                e = e || this.parent._renderer._textSize;
                for (var l = 0; l < k.length; l++) {
                    if (!h(l)) for (var m = k[l].getPath(b, c, e), n = f(m.commands), o = 0; o < n.length; o++) for (var p = d(n[o], g), q = 0; q < p.length; q++) p[q].x += i, j.push(p[q]);
        ...
        61: [function (a, b, c) {
            ...
            function d(a, b, c) {
                var d = a < 0, e = d ? a.toString().substring(1) : a.toString(), f = e.indexOf("."),
                    g = -1 !== f ? e.substring(0, f) : e, h = -1 !== f ? e.substring(f + 1) : "", i = d ? "-" : "";
                if (void 0 !== c) {
                    var j = "";
            ...
            function e(a, b) {
                a = a.toString();
                var c = a.indexOf("."), d = -1 !== c ? a.substring(c) : "", e = -1 !== c ? a.substring(0, c) : a;
                if (e = e.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","), 0 === b) d = ""; else if (void 0 !== b) if (b > d.length) {
                    d += -1 === c ? "." : "";
        ...
        63: [function (a, b, c) {
            ...
            var f = function (a, b, c, e, f, g, h) {
                ...
                if (h) for (v += p[f], j = 0; j < p[f + 1]; ++j) l = (j + 1) % p[f + 1], this.faces.push([v + j, v + l, v + p[f + 1]])
            };
            d.prototype.cylinder = function (a, b, c, e, g, h) {
                ...
                if (!this._renderer.geometryInHash(g)) {
                    var h = function () {
                        for (var a = 0; a <= this.detailY; a++) for (var b = a / this.detailY, c = Math.PI * b - Math.PI / 2, e = Math.cos(c), f = Math.sin(c), g = 0; g <= this.detailX; g++) {
                            var h = g / this.detailX, i = 2 * Math.PI * h, j = Math.cos(i), k = Math.sin(i),
                ...
                if (this._assert3d("torus"), d._validateParameters("torus", arguments), void 0 === a) a = 50; else if (!a) return;
                if (void 0 === b) b = 10; else if (!b) return;
                void 0 === c && (c = 24), void 0 === e && (e = 16);
                var f = (b / a).toPrecision(4), g = "torus|" + f + "|" + c + "|" + e;
                if (!this._renderer.geometryInHash(g)) {
                    var h = function () {
                        for (var a = 0; a <= this.detailY; a++) for (var b = a / this.detailY, c = 2 * Math.PI * b, e = Math.cos(c), g = Math.sin(c), h = 1 + f * e, i = 0; i <= this.detailX; i++) {
                            var j = i / this.detailX, k = 2 * Math.PI * j, l = Math.cos(k), m = Math.sin(k),
                                n = new d.Vector(h * l, h * m, f * g), o = new d.Vector(e * l, e * m, g);
                ...
                var b = a[0], c = a[1], e = a[2], f = a[3], g = a[4], h = a[5], i = "tri";
                ...
                var b, c, f = arguments[0], g = arguments[1], h = arguments[2], i = arguments[3], j = arguments[4],
                    k = arguments[5], l = arguments[6], m = arguments[7] || 25;
                if (Math.abs(k - j) >= e.TWO_PI ? (b = "ellipse", c = b + "|" + m + "|") : (b = "arc", c = b + "|" + j + "|" + k + "|" + l + "|" + m + "|"), !this.geometryInHash(c)) {
                    var n = function () {
                        if (this.strokeIndices = [], j.toFixed(10) !== k.toFixed(10)) {
                            ...
                            for (var a = 0; a <= m; a++) {
                                var b = a / m, c = (k - j) * b + j, f = .5 + Math.cos(c) / 2, g = .5 + Math.sin(c) / 2;
                ...
                var b = this.attributes.perPixelLighting, c = a[0], e = a[1], f = a[2], g = a[3],
                    h = a[4] || (b ? 1 : 24), i = a[5] || (b ? 1 : 16), j = "rect|" + h + "|" + i;
                if (!this.geometryInHash(j)) {
                    var k = function () {
                        for (var a = 0; a <= this.detailY; a++) for (var b = a / this.detailY, c = 0; c <= this.detailX; c++) {
                ...
                this.beginShape();
                for (var n = 0; n <= m; n++) {
                    var o = Math.pow(1 - n / m, 3), p = n / m * 3 * Math.pow(1 - n / m, 2),
                        q = 3 * Math.pow(n / m, 2) * (1 - n / m), r = Math.pow(n / m, 3);
                ...
                this.beginShape();
                for (var n = 0; n <= m; n++) {
                    var o = .5 * Math.pow(n / m, 3), p = .5 * Math.pow(n / m, 2), q = n / m * .5, r = .5,
        ...
        64: [function (a, b, c) {
            ...
            d.prototype.camera = function () {
                ...
                var f = 1 / Math.tan(this.cameraFOV / 2), g = 1 / (this.cameraNear - this.cameraFar);
                ...
                var h = b - a, i = e - c, j = g - f, k = 2 / h, l = 2 / i, m = -2 / j, n = -(b + a) / h,
                    o = -(e + c) / i, p = -(g + f) / j;
        ...
        66: [function (a, b, c) {
            ...
            d.prototype.ambientLight = function (a, b, c, e) {
                ...
                var f = this.color.apply(this, arguments), g = this._renderer._useLightShader();
        ...
        68: [function (a, b, c) {
            ...
            a("./p5.Texture"), d.prototype.loadShader = function (a, b) {
                ...
                var c = new d.Shader, e = this, f = !1, g = !1;
                ...
                var b = this.GL, c = this.drawMode === e.TEXTURE;
        ...
        69: [function (a, b, c) {
            ...
            d.Geometry = function (a, b, c) {
                ...
                var b = this.faces[a], c = this.vertices[b[0]], e = this.vertices[b[1]], f = this.vertices[b[2]],
                    g = d.Vector.sub(e, c), h = d.Vector.sub(f, c), i = d.Vector.cross(g, h), j = d.Vector.mag(i),
                ...
                for (var f = 0; f < e.length; ++f) for (var g = e[f], h = this._getFaceNormal(f), i = 0; i < 3; ++i) {
                    var j = g[i];
                    b[j].add(h)
                }
                ...
                if (this.edges.length = 0, Array.isArray(this.strokeIndices)) for (var a = 0, b = this.strokeIndices.length; a < b; a++) this.edges.push(this.strokeIndices[a]); else for (var c = 0; c < this.faces.length; c++) this.edges.push([this.faces[c][0], this.faces[c][1]]), this.edges.push([this.faces[c][1], this.faces[c][2]]), this.edges.push([this.faces[c][2], this.faces[c][0]]);
                return this
                ...
                for (var a = 0; a < this.edges.length; a++) {
                    var b = this.vertices[this.edges[a][0]], c = this.vertices[this.edges[a][1]],
                        d = c.copy().sub(b).normalize(), e = b.array(), f = b.array(), g = c.array(), h = c.array(),
                        i = d.array(), j = d.array();
        ...
        70: [function (a, b, c) {
            "use strict";
            var d = a("../core/main"), e = Array, f = function (a) {
            ...
            "undefined" != typeof Float32Array && (e = Float32Array, f = function (a) {
                ...
                var t = b * i - c * h, u = b * j - e * h, v = b * k - g * h, w = c * j - e * i, x = c * k - g * i,
                    y = e * k - g * j, z = l * q - m * p, A = l * r - n * p, B = l * s - o * p, C = m * r - n * q,
                ...
                if (b) b.transpose3x3(this.mat3); else for (var c = 0; c < 9; c++) this.mat3[c] = 0;
                return this
                ...
                var b;
                if (a === this || a === this.mat4) b = this.copy().mat4; else if (a instanceof d.Matrix) b = a.mat4; else {
                    if (!f(a)) return;
                    b = a
                }
                var c = this.mat4[0], e = this.mat4[1], g = this.mat4[2], h = this.mat4[3];
                ...
                b *= 1 / g, c *= 1 / g, e *= 1 / g;
                var h = this.mat4[0], i = this.mat4[1], j = this.mat4[2], k = this.mat4[3], l = this.mat4[4],
                    m = this.mat4[5], n = this.mat4[6], o = this.mat4[7], p = this.mat4[8], q = this.mat4[9],
                    r = this.mat4[10], s = this.mat4[11], t = Math.sin(f), u = Math.cos(f), v = 1 - u,
                    w = b * b * v + u, x = c * b * v + e * t, y = e * b * v - c * t, z = b * c * v - e * t,
                    A = c * c * v + u, B = e * c * v + b * t, C = b * e * v + c * t, D = c * e * v - b * t,
                    E = e * e * v + u;
        ...
        73: [function (a, b, c) {
            ...
            d.RendererGL = function (a, b, c, e) {
                ...
                var e = this.width, f = this.height, g = this.canvas.id, h = this.canvas;
                ...
                var a = this._pInst.color.apply(this._pInst, arguments), b = a.levels[0] / 255, c = a.levels[1] / 255,
                    d = a.levels[2] / 255, e = a.levels[3] / 255;
                ...
                var a = this._pInst._pixelDensity, b = this.width, c = this.height;
                ...
                var a = arguments[0] || 0, b = arguments[1] || 0, c = arguments[2] || 0, d = arguments[3] || 0;
                ...
                var a = d.Renderer.prototype.push.apply(this), b = a.properties;
            ...
            d.Shader = function (a, b, c) {
                ...
                if (!this._loadedAttributes) {
                    ...
                    for (var a = this._renderer.GL, b = a.getProgramParameter(this._glProgram, a.ACTIVE_ATTRIBUTES), c = 0; c < b; ++c) {
                        var d = a.getActiveAttrib(this._glProgram, c), e = d.name,
                            f = a.getAttribLocation(this._glProgram, e), g = {};
        ...
        75: [function (a, b, c) {
            ...
            d.Texture = function (a, b) {
                ...
                var c = this._renderer.GL, d = function (a) {
                    return 0 == (a & a - 1)
                }, f = d(this.width), g = d(this.width);
